...
interface RetirementChartProps {
  data: { name: string; Corpus: number; Withdrawals: number; Contributions: number }[];
  formatCurrency: (val: number) => string;
}

export default function RetirementChart({ data, formatCurrency }: RetirementChartProps) {
  return (
